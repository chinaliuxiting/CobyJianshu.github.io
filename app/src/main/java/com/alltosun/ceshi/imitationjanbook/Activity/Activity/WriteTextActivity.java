package com.alltosun.ceshi.imitationjanbook.Activity.Activity;
...
import Myview.RichEditor;

public class WriteTextActivity extends BaseActivity implements View.OnClickListener {
        ...
        view.findViewById(R.id.btn_ok).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (linkAddress.endsWith("http://") || TextUtils.isEmpty(linkAddress)) {
                    Toast.makeText(WriteTextActivity.this, "请输入超链接地址", Toast.LENGTH_SHORT);
                } else if (TextUtils.isEmpty(linkTitle)) {
                    Toast.makeText(WriteTextActivity.this, "请输入超链接标题", Toast.LENGTH_SHORT);
                } else {
